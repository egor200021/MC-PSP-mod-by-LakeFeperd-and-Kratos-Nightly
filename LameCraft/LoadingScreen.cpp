...
int LoadingScreen::RunLoadingScreen(SceSize args, void *argp)
{
	...
	while(1)
	{
		...
		switch(random_message)
		{
			...
			break;
			case 9:
				RenderManager::InstancePtr()->DebugPrint(240,136,"UNLIMITED WORLD COMMING SOON");
			break;
			case 10:
			...
			break;
			case 13:
				RenderManager::InstancePtr()->DebugPrint(240,136,"RETWITTED");
			break;
			case 14:
				RenderManager::InstancePtr()->DebugPrint(240,136,"MEMORY LEAK");
			break;
			case 15:
			...
			break;
			case 17:
				RenderManager::InstancePtr()->DebugPrint(240,136,"MOTHAFACKA LET'S GO!");
			break;
			case 18:
			...
			break;
			case 25:
				RenderManager::InstancePtr()->DebugPrint(240,136,"BASS CANNON");
			break;
			case 26:
